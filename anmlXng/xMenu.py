...
class MapGoMenu(Menu):
    def __init__(self,name,button,mapMenu):
        ...
        self.subMenu["go"] = MenuButton("go",TouchPoint(800, 1550,10),button)
...
class MapMenu(Menu):
    def __init__(self,mainMenu):
        ...
        self.subMenu["creek"]  = MapButtonMenu("creek", TouchPoint(185, 1030),self)
        self.subMenu["ok"]     = MapButtonMenu("ok",    TouchPoint(860, 1030),self)
        self.subMenu["market"] = MapButtonMenu("market",TouchPoint(330, 1250),self)
        self.subMenu["hollow"] = MapButtonMenu("hollow",TouchPoint(930, 1300),self)
        self.subMenu["camp"]   = MapButtonMenu("camp",  TouchPoint(600, 1350),self)
        self.subMenu["island"] = MapButtonMenu("island",TouchPoint(250, 1550),self)
        self.subMenu["shore"]  = MapButtonMenu("shore", TouchPoint(800, 1630),self)
